...
<html lang="es">
	...
	<body>
		...
		<header>
			...
			<div class="area-logo">
				<a href="index.php"><img src="img/varios/logo-cinestar.png"/></a>
			</div>
			<nav class="menu">
				...
				<ul class="menu-principal">
		    		<li class="menu-item"><a href="pelicula.php">Cartelera</a></li>
		       		<li class="menu-item"><a href="peliculas.php?id=estrenos">Próximos estrenos</a></li>
		       		<li class="menu-item"><a href="http://www.cinestar.com.pe/starcard">Star Card</a></li>
		        	<li class="menu-item"><a href="cines.php">Nuestros Cines</a></li>
